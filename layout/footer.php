      ...
      <div class="container">
            <div class="row">
                <div class="col-md-6 text-center">
                    ...
                    <p>L’équipe <a href="/" class="orange">LocaSun</a> est à votre écoute pour toute demande </p>
                        <br><br><br>
                    <a href="#" class="button-style-1" >Contactez-nous</a>
                        <br><br><br><br>
                </div>
                ...
                <div class="col-md-5">
                      ...
                      <p class="orange">
                          ...
                          <a href="#" class="orange">06 87 89 65 25</a>
                      </p>

                      <p class="orange">
                          <i class="fas fa-chevron-right">&nbsp;</i>
                          <span class="blanc">Mail :</span> 
                          <a href="#" class="orange">contact@locasun.com</a>
                      </p>
...
<section id="copyright">
   <div class="container text-center">
       &copy; <?php echo date('Y');?> Copyright <a href="#">LocaSun</a> | Tous droits réservés - <a href="#">Mentions Légales</a>
    </div>
</section>