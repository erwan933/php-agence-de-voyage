...
<title>Locasun | Votre agence de voyage</title>
    <body>
        ...
        <div class="topbar1 text-center responsive-none">
            ...
            <section class="section1">
               <div class="container">
                    <div class="row">
                        <div class="col-md-6">      
                             <article class=" w100">
                                    <img src="img/particulier.jpg" alt="Particulier" class="w100 shadow1">
                              </article>   
                        </div>
               ...
               <div class="container">
                    <div class="row">
                       <div class="col-md-5 align-middle">
                        ...
                        <div class="col-md-6">      
                             <article class=" w100">
                                    <img src="img/particulier2.jpg" alt="Particulier" class="w100 shadow1">
                              </article>   
                        </div>
                    </div>
                </div>
           ...
           <section class="section1">
                <div class="container">
                    ...
                    <div class="row text-center">
                         <div class="col-md-3">
                             <article class=" w100">
                                    <img src="img/mer.jpg" width="100%" alt="Mer">     
                              </article>
                             <p class="max-width1rem">Vacances à la mer</p>
                         </div>
                         <div class="col-md-3">
                             <article class=" w100">
                                    <img src="img/montagne.jpg" width="100%" alt="Montagne">
                              </article>
                              <p class="max-width1rem">Vacances à la montagne</p>
                         </div> 
                         <div class="col-md-3">
                             <article class=" w100">
                                    <img src="img/campagne.jpg" width="100%" alt="Campagne">
                              </article>
                              <p class="max-width1rem">Vacances à la campagne</p>
                         </div>
                         <div class="col-md-3">
                             <article class=" w100">
                                    <img src="img/archipels.jpg" width="100%" alt="Archipels">
                              </article>
